...
public class Game{
    ...
    private Door door1;
    private Door door2;
    private Screen startingScreen = new Screen("Assets/Screens/StartScreen_v2.jpg");
    private Screen storyScreen = new Screen("Assets/Screens/StoryScreen.jpg");
    private Screen robVictoryScreen = new Screen("Assets/Screens/Mushroom_Victory_v1.jpg");
    private Screen copVictoryScreen = new Screen("Assets/Screens/Wizard_Victory_v1.jpg");

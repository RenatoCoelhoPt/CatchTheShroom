...
public class PlayerCop extends Player implements KeyboardHandler, Runnable {
    ...
    public void run() {
        {
            try {
                    ...
                    if (movingRight && getPic().getX() < getField().getRectangle().getWidth()) {
                        while (movingRight) {
                            getPic().load("Assets/Wizard/Wizard_Idle + Walk_1.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle + Walk_2.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle + Walk_3.png");
                            Thread.sleep(20);
                            getPic().load("Assets/Wizard/Wizard_Idle + Walk_4.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle + Walk_1.png");
                            Thread.sleep(10);
                    ...
                    if (movingLeft && getPic().getX() > getField().getRectangle().getX()) {
                        while (movingLeft) {
                            getPic().load("Assets/Wizard/Wizard_Idle LEFT + Walk_1.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle LEFT + Walk_2.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle LEFT + Walk_3.png");
                            Thread.sleep(20);
                            getPic().load("Assets/Wizard/Wizard_Idle LEFT + Walk_4.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Wizard/Wizard_Idle LEFT + Walk_1.png");
                            Thread.sleep(10);
                            getPic().translate(-getCellSize(), 0);
    ...
    public void copInit() {
        ...
        pic = new Picture(32, 32, "Assets/Wizard/Wizard_Idle + Walk_1.png");
        pic.draw();

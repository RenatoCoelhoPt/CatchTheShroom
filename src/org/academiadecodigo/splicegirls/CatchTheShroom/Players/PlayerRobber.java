...
public class PlayerRobber extends Player implements KeyboardHandler, Runnable {
    ...
    public void run() {
        {
            try {
                    ...
                    if (movingRight && getPic().getX() < getField().getRectangle().getWidth()){
                        while (movingRight) {
                            getPic().load("Assets/Mushroom - Small/SmallMushroom_Walk_4.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom_Walk_1.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom_Walk_2.png");
                            Thread.sleep(20);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom_Walk_3.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom_Walk_4.png");
                            Thread.sleep(10);
                    ...
                    if (movingLeft && getPic().getX() > getField().getRectangle().getX()){
                        while (movingLeft) {
                            getPic().load("Assets/Mushroom - Small/SmallMushroom LEFT_Walk_4.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom LEFT_Walk_1.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom LEFT_Walk_2.png");
                            Thread.sleep(20);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom LEFT_Walk_3.png");
                            Thread.sleep(10);
                            getPic().load("Assets/Mushroom - Small/SmallMushroom LEFT_Walk_4.png");
                            Thread.sleep(10);
                            getPic().translate(-getCellSize(), 0);
    ...
    public void robberInit() {
        ...
        pic = new Picture(32, 32, "Assets/Mushroom - Small/SmallMushroom_Walk_1.png");
        pic.draw();
